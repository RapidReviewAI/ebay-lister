...
// TEST THIS IN BROWSER: https://ebay-lister-azure.vercel.app/api/generate-single
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: e.message, route: "api/generate-single" }, { status: 500 });
  }
}
